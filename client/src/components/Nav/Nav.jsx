...
export default function Nav(){
    ...
    return(
        <div className={`flex justify-between text-white bg-[#171616] py-5 `}>

            <div className="flex  small:text-3xl small:basis-1/4 justify-between ml-7 font-oswald text-4xl cursor-pointer"><Link to="/">Admin Dashboard</Link></div>
